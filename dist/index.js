...
})({"gqzVW":[function(require,module,exports) {
...
if (loginFormEl) loginFormEl.addEventListener("submit", (e)=>{
    ...
    console.log(555);
    (0, _loginJsDefault.default)(password, email);
});

},{"./login.js":"7yHem","./mapBox.js":"k6XpQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7yHem":[function(require,module,exports) {
/* eslint-disable */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
console.log("✨");
exports.default = async (password, email)=>{
    console.log(456);
    try {
        console.log(789);
...
exports.default = (locations)=>{
    ...
    locations.forEach((el)=>{
        new mapboxgl.Popup({
            closeOnClick: false,
            offset: 50
        }).setLngLat(el.coordinates).setHTML(`Day ${el.day} : ${el.description}`).addTo(map);
    });
    // DISABLE SCROLL ZOOM
    map.scrollZoom.disable();
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gqzVW","f2QDv"], "f2QDv", "parcelRequire7e89")
